    ...
    <div class="content-container">
        ...
        <div class="content-breadcrumb-box">
            <div class="breadcrumbs">
                <p><a href="http://localhost/urban/backoffice/">Dashboard</a> / <a href="http://localhost/urban/backoffice/catalogo/atributos/colores/">Colores</a></p>
            </div>
        </div>

        <div class="content-header">
            <h1 class="content-title">Colores</h1>
        </div>
        ...
        <div class="form-container">
            ...
            <form class="form-element" id="form-atributos" data-form="color">
                ...
                <div class="form-group" data-required="true" data-type="color">
                    ...
                    <input type="color" class="form-color" name="codigo_hex">
                ...
                <div class="form-group" data-required="true" data-type="text">
                    ...
                    <input type="text" class="form-input" name="nombre" maxlength="25" autocomplete="off">
                ...
                <div class="form-submit">
                    <button class="form-submit-btn" type="submit">Añadir color</button>
                </div>
