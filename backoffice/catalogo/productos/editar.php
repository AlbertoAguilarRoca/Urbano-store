...
include_once __DIR__ . '/../../model/managers/ProductManager.php';
...
$producto = $productManager -> getProductById($ref);
    ...
    <div class="content-container">
        ...
        <div class="content-breadcrumb-box">
            <div class="breadcrumbs">
                <p><a href="http://localhost/urban/backoffice/">Dashboard</a> / <a href="http://localhost/urban/backoffice/catalogo/productos/">Productos</a> / Editar producto</p>
            </div>
        </div>

        <div class="content-header">
            <h1 class="content-title"><?php echo $producto['nombre'] ?></h1>
        </div>
        ...
        <div class="form-container">
            ...
            <form class="form-element" id="form-product">
                ...
                <div class="product-form-row">
                    ...
                    <div class="product-form-col">
                        ...
                        <div class="form-group" data-required="true" data-type="text">
                            ...
                            <input type="text" class="form-input" name="nombre" maxlength="100" autocomplete="off" value="<?php echo $producto['nombre']; ?>">
                        ...
                        <div class="form-group" data-required="true" data-type="select">
                            ...
                            <select class="form-select" name="subcategoria">
                                ...
                                for ($i = 0; $i < $subcategorias->num_rows; $i++) {
                                    ...
                                    if ($fila['id'] != '0') {
                                        if($fila['id'] == $producto['subcategoria']) {
                                            echo "<option selected value='" . $fila['id'] . "'>" . $fila['nombre'] . "</option>";
                                        } else {
                                            echo "<option value='" . $fila['id'] . "'>" . $fila['nombre'] . "</option>";
                                        }
                        ...
                        <div class="form-group pb-5" data-required="true" data-type="date">
                            ...
                            <input class="form-date" type="date" class="form-date" name="fecha_creacion" value="<?php echo $producto['fecha_creacion'] ?>">
                        ...
                        <div class="product-form-col-group">
                            <div>
                                ...
                                <div class="form-status-area">
                                    <div id="status" class="form-status-selector <?php if($producto['estado'] == 0) echo 'inactivo'; ?>">
                                        <div class="form-status-ball"></div>
                                    </div>
                                    <input id="status-checkbox" type="checkbox" name="estado" class="form-status-checkbox" <?php if($producto['estado'] == 1) echo 'checked'; ?> value="yes">
                                    <span id="status-info" class="form-admin-status-info"><?php if($producto['estado'] == 0) {echo 'Inactivo';} else {echo 'Activo';} ?>"</span>
                                </div>
                            </div>
                        ...
                        <div class="product-form-col-group">
                            ...
                            <div class="form-group pr-5" data-required="true" data-type="text">
                                ...
                                <input type="text" class="form-input" name="precio" autocomplete="off" id="precio-sin" value="<?php echo $producto['precio'] ?>">
                        ...
                        <div class="sizes-box" id="tallas-contenedor"><?php

                            $tallasProd = $productManager -> getTallasById($ref);

                            for($i = 0; $i < $tallasProd -> num_rows; $i++) {
                                $fila = $tallasProd -> fetch_assoc();

                                echo '<ul class="conditions-list-body" id="'.str_replace(' ', '', $fila['talla']).'" data-id-talla="'.$fila['id_talla'].'" data-text="'.$fila['talla'].'" data-stock="'.$fila['cantidad'].'" data-stock-min="'.$fila['stock_minimo'].'">
                                <li>Talla: '.$fila['talla'].'</li>
                                <li>Cantidad: '.$fila['cantidad'].'</li>
                                <li>Stock mínimo: '.$fila['stock_minimo'].'</li>
                                <li>
                                    <button type="button" data-id="'.str_replace(' ', '', $fila['talla']).'" class="btn-condition-delete btn-delete-size" >
                        ...
                        <div class="sizes-box" id="ref-product-contenedor"><?php
                        
                            $refProducts = $productManager -> getProdRefById($ref);
                            
                            for($i = 0; $i < $refProducts -> num_rows; $i++) {
                                $fila = $refProducts -> fetch_assoc();

                                echo '<ul class="conditions-list-body" id="'.$fila['ref_producto_rel'].'">
                                    <li>Referencia: '.$fila['ref_producto_rel'].'</li>
                                    <li>
                                        <button type="button" data-id="'.$fila['ref_producto_rel'].'" class="btn-condition-delete btn-delete-ref" >
                                            <i class="bi bi-x-lg"></i>
                                        </button>
                                    </li>
                                </ul>';
                    ...
                    <div class="product-form-col">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-display-images" id="display-images">
                                ...
                                <?php 
                                    ...
                                    $imgProd = $productManager -> getImgById($ref);

                                    for($i = 0; $i < $imgProd -> num_rows; $i++) {
                                        $fila = $imgProd -> fetch_assoc();
                                ?>
                                    <div class="product-img" data-img="<?php echo $fila['nombre']; ?>">
                                        <img src="data:<?php echo $fila['tipo'] ?>;base64,<?php echo base64_encode($fila['img']); ?>" alt="<?php echo $fila['nombre']; ?>">
                                    </div>
                                <?php } ?>
                            </div>
                        ...
                        <div class="form-group" data-required="true" data-type="text">
                            ...
                            <textarea class="form-input" name="resumen" maxlength="300" rows="5"><?php echo $producto['resumen']; ?></textarea>
                        ...
                        <div class="form-group" data-required="true" data-type="text">
                            ...
                            <textarea class="form-input" name="caracteristicas" maxlength="500" rows="7"><?php echo $producto['caracteristicas']; ?></textarea>
                            <p class="input-error-info">Campo vacío.</p>
                            <div class="form-group-info">
                ...
                <div class="form-submit">
                    ...
                    <button class="form-submit-btn" type="submit">Editar producto</button>
                </div>
...
<div class="overlay-delete">
    ...
    <div class="confirm-delete">
        ...
        <p class="form-delete-text-info">Borrar un producto implica borrar todos los registros de la base de datos relacionado con el propio producto. Recuerda que siempre puedes marcarlo como inactivo. ¿Deseas continuar?</p>
        <p class="form-delete-text-info">Escribe '<span class="type-delete" id="type-delete">Eliminar <?php echo $producto['nombre']; ?></span>' para continuar.</p>
        <form id="form-delete">
            <div class="form-group" data-required="true" data-type="delete">
                <input type="text" class="form-input" name="delete" autocomplete="off" data-content-delete="Eliminar <?php echo $producto['nombre']; ?>">
